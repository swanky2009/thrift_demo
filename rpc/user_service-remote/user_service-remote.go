...
func Usage() {
  ...
  fmt.Fprintln(os.Stderr, "  i64 AddUser(string name, i16 age)")
  fmt.Fprintln(os.Stderr, "  User GetUser(i32 uid)")
  fmt.Fprintln(os.Stderr, "   GetAllUsers(i32 rows, i32 page)")
  fmt.Fprintln(os.Stderr, "  User UpdateUser(i32 uid, string name, i16 age)")
  fmt.Fprintln(os.Stderr, "  i64 DeleteUser(i32 uid)")
  fmt.Fprintln(os.Stderr)
  os.Exit(0)
}
...
func main() {
  ...
  client := rpc.NewUserServiceClientFactory(trans, protocolFactory)
  ...
  case "GetAllUsers":
    if flag.NArg() - 1 != 2 {
      fmt.Fprintln(os.Stderr, "GetAllUsers requires 2 args")
      flag.Usage()
    }
    ...
    value1 := argvalue1
    fmt.Print(client.GetAllUsers(value0, value1))
    fmt.Print("\n")
    break
  case "UpdateUser":
    if flag.NArg() - 1 != 3 {
  ...
  case "DeleteUser":
    ...
    argvalue0 := int32(tmp0)
    value0 := argvalue0
    fmt.Print(client.DeleteUser(value0))
    fmt.Print("\n")
    break
  case "":
    Usage()
